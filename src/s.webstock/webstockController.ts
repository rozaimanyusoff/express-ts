...
export const list = async (req: Request, res: Response) => {
  ...
  return res.json({ data: items, message: 'Location types retrieved successfully', status: 'success' });
};
...
export const getById = async (req: Request, res: Response) => {
  ...
  return res.json({ data: item, status: 'success' });
};
...
export const create = async (req: Request, res: Response) => {
  ...
  return res.status(201).json({ id, message: 'Location type created', status: 'success' });
};
...
export const update = async (req: Request, res: Response) => {
  ...
  return res.json({ message: 'Location type updated', status: 'success' });
};

export const remove = async (req: Request, res: Response) => {
  const id = Number(req.params.id);
  await model.deleteLocationType(id);
  return res.json({ message: 'Location type deleted', status: 'success' });
};
...
export const listLocations = async (_req: Request, res: Response) => {
  ...
  return res.json({ data: items, message: 'Locations retrieved successfully', status: 'success' });
};
...
export const getLocation = async (req: Request, res: Response) => {
  ...
  return res.json({ data: item, message: 'Location by ID retrieved successfully', status: 'success' });
};

export const createLocation = async (req: Request, res: Response) => {
  const id = await model.createLocation(req.body);
  return res.status(201).json({ id, message: 'Location created', status: 'success' });
};

export const updateLocation = async (req: Request, res: Response) => {
  const id = Number(req.params.id);
  await model.updateLocation(id, req.body);
  return res.json({ message: 'Location updated', status: 'success' });
};

export const deleteLocation = async (req: Request, res: Response) => {
  const id = Number(req.params.id);
  await model.deleteLocation(id);
  return res.json({ message: 'Location deleted', status: 'success' });
};
...
export const listFixedAssets = async (_req: Request, res: Response) => {
  ...
  return res.json({ data: items, message: 'Fixed assets retrieved successfully', status: 'success' });
};
