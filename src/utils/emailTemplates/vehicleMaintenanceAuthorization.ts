export default function vehicleMaintenanceAuthorizationEmail(data: any): string {
  ...
  <title>Vehicle Maintenance ${roleWord}</title>
  </head>
      ...
      <tr>
        <td align="center" style="padding:28px 12px">
          <table width="500" cellpadding="0" cellspacing="0" role="presentation" style="width:100%; max-width:500px; background:#ffffff; border-radius:10px; overflow:hidden; box-shadow:0 6px 20px rgba(17,24,39,0.08);">
            <tr>
              <td style="background:linear-gradient(90deg,#0052cc,#0066ff); padding:16px 20px; color:#fff;">
                <div style="display:flex;align-items:center;justify-content:space-between;">
                  <div style="font-weight:700;font-size:18px">Vehicle Maintenance ${roleWord}</div>
            ...
            <tr>
              <td style="padding:18px 22px 6px 22px;">
                <p style="margin:0 0 10px 0; color:#253858; font-size:14px">Dear Authorized Personnel,</p>
                <p style="margin:0;color:#42526e;font-size:13px;line-height:1.45">This application requires your <strong>${roleWord.toLowerCase()}</strong>. Please proceed to the portal to complete your action.</p>
              </td>
            </tr>
            ...
            <tr>
              <td style="padding:0 20px 20px 20px">
                <a href="${portalUrl}" target="_blank" style="display:inline-block;background:#0052CC;color:#fff;padding:11px 16px;border-radius:6px;text-decoration:none;">Open Maintenance Portal</a>
                <div style="font-size:12px;color:#6b778c;margin-top:8px">For security reasons, authorization must be completed in the portal; direct replies to this email will not be processed.</div>
              </td>
            </tr>
