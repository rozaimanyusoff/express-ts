export function renderFleetCardCreatedNotification(opts: {
  cardId?: number;
  cardNo?: string;
  ...
  <head>
    ...
    <title>Fleet Card Created</title>
  </head>
      ...
      <tr>
        <td align="center">
          <table width="600" cellpadding="0" cellspacing="0" role="presentation" style="background:#ffffff; border-radius:8px; overflow:hidden; box-shadow:0 2px 8px rgba(0,0,0,0.1);">
            ...
            <!-- Header -->
            <tr>
              <td style="background:linear-gradient(135deg, #007bff 0%, #0056b3 100%); padding:24px 20px; color:#fff;">
                <div style="font-size:22px; font-weight:700;">Fleet Card Created</div>
                <div style="font-size:13px; opacity:0.9; margin-top:4px;">Successful Creation Notification</div>
              </td>
            </tr>
            ...
            <tr>
              <td style="padding:28px 20px;">
                ...
                <p style="margin:0 0 20px 0; font-size:14px; line-height:1.6; color:#555;">
                  You have successfully created a new fleet card. Here are the details:
                </p>
                ...
                <div style="background:#f9f9f9; padding:16px; border-radius:6px; margin:20px 0; border-left:4px solid #007bff;">
                  <div style="font-weight:600; color:#007bff; margin-bottom:12px;">Assigned Asset</div>
