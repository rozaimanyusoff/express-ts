...
export async function getBillingByAccountDateRange(accountId: number, from: string, to: string) {
...
export async function getTelcoBillingByAccountDateRange(accountId: number, from: string, to: string) {
    return getBillingByAccountDateRange(accountId, from, to);
}
